...
class VentanaPrincipal(QMainWindow):
    ...
    def crear_pestaña_principal(self):
        ...
        # Botones marcador local - CON IMÁGENES
        botones_local = QHBoxLayout()
        
        # Botón +1 (pelota1.png)
        btn_plus_1_local = QPushButton()
        btn_plus_1_local.setIcon(self.cargar_icono("imagenes/pelota1.png"))
        ...
        btn_plus_2_local.setIcon(self.cargar_icono("imagenes/pelota2.png"))
        ...
        btn_plus_3_local.setIcon(self.cargar_icono("imagenes/pelota3.png"))
        ...
        # Botones marcador visitante - CON IMÁGENES
        botones_visitante = QHBoxLayout()
        
        # Botón +1 (pelota1.png)
        btn_plus_1_visitante = QPushButton()
        btn_plus_1_visitante.setIcon(self.cargar_icono("imagenes/pelota1.png"))
        ...
        btn_plus_2_visitante.setIcon(self.cargar_icono("imagenes/pelota2.png"))
        ...
        btn_plus_3_visitante.setIcon(self.cargar_icono("imagenes/pelota3.png"))
